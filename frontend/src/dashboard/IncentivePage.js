...
import { downloadIncentiveCompanyReport } from './incentiveCompanyExport';
import {
...
function buildLoadBrandPricingLookup(loads) {
  ...
  for (const load of loads) {
    ...
    for (const b of BRANDS) {
      ...
      map.set(`${stockId}|${b.key}`, { perBagPrice, cutOffPrice, transportPerBag, marginPerBag, totalCostPerBag });
    }
  }
  return map;
}
...
export default function IncentivePage() {
  ...
  }, [distributionRows, search, dateFrom, dateTo]);
