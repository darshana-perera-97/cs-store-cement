  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-slate-500">
        Configure SMTP and company details used in customer emails. Bills, payments, and free bag
        promotions are emailed automatically when a customer has an email address and notifications
        are enabled.
      </p>
